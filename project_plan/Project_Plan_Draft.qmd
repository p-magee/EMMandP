...
-   Assess the relationship between `Amount forgiven` and other variables like `Rent`, `Jobs reported`, `Business type`, `Industry`, `Age of business`, `Utilities`, etc.
...
-   Maintain/submit Github, using branching.

-   Periodic check-ins to track progress and divide the work.
